...
2. Packages the current 12-module standalone verification slice.
...
The beta ZIP includes the current 12-module Ashfall/ECHO verification slice:
...
This content set is intentionally labeled as a graph-first playable vertical slice. It verifies the standalone engine path and module graph behavior, but it does not claim full Ashfall gameplay parity with the existing NeoForge or legacy Standalone Runtime lanes.
